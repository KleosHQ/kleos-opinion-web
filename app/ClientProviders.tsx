    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-8">
        <div className="max-w-xl text-center">
          <h1 className="text-2xl font-bold mb-3 text-red-400">Configuration Error</h1>
          <p className="text-zinc-500 mb-6">
            Set <code className="px-2 py-0.5 rounded-lg bg-zinc-800/80 border border-zinc-700 text-sm">NEXT_PUBLIC_PRIVY_APP_ID</code> in your <code className="px-2 py-0.5 rounded-lg bg-zinc-800/80 border border-zinc-700 text-sm">.env</code> file.
          </p>
...
FAIRSCALE_API_KEY=...`}
            ...
            <a href="https://privy.io" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:underline text-sm mt-4 inline-block">
              Get Privy App ID
            </a>
          </div>
        </div>
